...
export default function Header({ title }: HeaderProps) {
  ...
  return (
    <header className="relative z-40 pt-[env(safe-area-inset-top)] lg:pt-3">
      <div
        aria-hidden="true"
        className="ag-emerald-plate pointer-events-none absolute inset-x-0 top-0 h-[env(safe-area-inset-top)] lg:hidden"
      />
